          ...
          <div class="card-content">
            <div class="content">
              ...
              <div class="field">
                ...
                />
                <p class="comment">My Origin began on {{selectedHero.originDate | shortDate}}</p>
              </div>
              <div class="field">
...
const ourHeroes = [
  {
    ...
    lastName: 'Papa',
    capeCounter: 1,
    originDate: format(new Date(2010, 3, 9), inputDateFormat),    
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 4,
    originDate: format(new Date(2010, 3, 10), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 2,
    originDate: format(new Date(2010, 3, 11), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 3,
    originDate: format(new Date(2010, 3, 12), inputDateFormat),
  ...
  watch: {
     'selectedHero.capeCounter':{
      ...
      handler(newValue, oldValue) {
        console.log(`Watcher is evaluated old=${oldValue} new=${newValue}`)
